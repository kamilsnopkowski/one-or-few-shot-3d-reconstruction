#!/usr/bin/env python3
"""Run a hardcoded batch of MapAnything reconstruction CLI tests."""
...
TESTS_ETH3D = [
    # Edit this list manually. Each src can be a string or a list of strings.
    # {"test_name": "custom_example_test", "src": ["../data/example_images"]},
    {"test_name": "eth3d_botanical_garden_1", "src": ["../dataset/eth3d/botanical_garden/images/scen_1"]},
    ...
    {"test_name": "eth3d_boulders_scen_1", "src": ["../dataset/eth3d/boulders/images/scen_1"]},
    ...
    {"test_name": "eth3d_bridge_scen_1", "src": ["../dataset/eth3d/bridge/images/scen_1"]},
    ...
    {"test_name": "eth3d_door_scen_1", "src": ["../dataset/eth3d/door/images/scen_1"]},
    ...
    {"test_name": "eth3d_exhibition_hall_scen_1", "src": ["../dataset/eth3d/exhibition_hall/images/scen_1"]},
    ...
    {"test_name": "eth3d_lecture_room_scen_1", "src": ["../dataset/eth3d/lecture_room/images/scen_1"]},
    ...
    {"test_name": "eth3d_lounge_scen_1", "src": ["../dataset/eth3d/lounge/images/scen_1"]},
    ...
    {"test_name": "eth3d_observatory_scen_1", "src": ["../dataset/eth3d/observatory/images/scen_1"]},
    ...
    {"test_name": "eth3d_observatory_scen_4", "src": ["../dataset/eth3d/observatory/images/scen_4"]},
    {"test_name": "eth3d_old_computer_scen_1", "src": ["../dataset/eth3d/old_computer/images/scen_1"]},
    ...
    {"test_name": "eth3d_statue_scen_1", "src": ["../dataset/eth3d/statue/images/scen_1"]},
    ...
    {"test_name": "eth3d_terrace_2_scen_1", "src": ["../dataset/eth3d/terrace_2/images/scen_1"]},
...
TESTS_LLFF = [
    ...
    {"test_name": "llff_fern_scen_1", "src": ["../dataset/nerf_llff_data/fern/images/scen_1"]},
    ...
    {"test_name": "llff_flower_scen_1", "src": ["../dataset/nerf_llff_data/flower/images/scen_1"]},
    ...
    {"test_name": "llff_fortress_scen_1", "src": ["../dataset/nerf_llff_data/fortress/images/scen_1"]},
    ...
    {"test_name": "llff_horns_scen_1", "src": ["../dataset/nerf_llff_data/horns/images/scen_1"]},
    ...
    {"test_name": "llff_leaves_scen_1", "src": ["../dataset/nerf_llff_data/leaves/images/scen_1"]},
    ...
    {"test_name": "llff_orchids_scen_1", "src": ["../dataset/nerf_llff_data/orchids/images/scen_1"]},
    ...
    {"test_name": "llff_room_scen_1", "src": ["../dataset/nerf_llff_data/room/images/scen_1"]},
    ...
    {"test_name": "llff_trex_scen_1", "src": ["../dataset/nerf_llff_data/trex/images/scen_1"]},
...
TESTS_CUSTOM = [
    # Edit this list manually. Each src can be a string or a list of strings.
    # {"test_name":custom_ "example_test", "src": ["../data/example_images"]},
    {"test_name": "custom_room_1_scen_1", "src": ["../dataset/custom/room_1/images/scen_1"]},
    ...
    {"test_name": "custom_office_scen_1", "src": ["../dataset/custom/office/images/scen_1"]},
    ...
    {"test_name": "custom_synagogue_scen_1", "src": ["../dataset/custom/synagogue/images/scen_1"]},
    ...
    {"test_name": "custom_statue_scen_1", "src": ["../dataset/custom/statue/images/scen_1"]},
    ...
    {"test_name": "custom_cafe_scen_1", "src": ["../dataset/custom/cafe/images/scen_1"]},
    ...
    {"test_name": "custom_room_2_scen_1", "src": ["../dataset/custom/room_2/images/scen_1"]},
    ...
    {"test_name": "custom_bush_1_scen_1", "src": ["../dataset/custom/bush_1/images/scen_1"]},
    ...
    {"test_name": "custom_room_3_scen_1", "src": ["../dataset/custom/room_3/images/scen_1"]},
    ...
    {"test_name": "custom_room_5_scen_1", "src": ["../dataset/custom/room_5/images/scen_1"]},
    ...
    {"test_name": "custom_millenium_falcon_scen_1", "src": ["../dataset/custom/millenium_falcon/images/scen_1"]},
    ...
    {"test_name": "custom_tennis_table_scen_1", "src": ["../dataset/custom/tennis_table/images/scen_1"]},
    ...
    {"test_name": "custom_church_scen_1", "src": ["../dataset/custom/church/images/scen_1"]},
    ...
    {"test_name": "custom_mural_bird_scen_1", "src": ["../dataset/custom/mural_bird/images/scen_1"]},
    ...
    {"test_name": "custom_kettle_scen_1", "src": ["../dataset/custom/kettle/images/scen_1"]},
    ...
    {"test_name": "custom_spqr_scen_1", "src": ["../dataset/custom/spqr/images/scen_1"]},
    ...
    {"test_name": "custom_mural_king_scen_1", "src": ["../dataset/custom/mural_king/images/scen_1"]},
    ...
    {"test_name": "custom_miscellaneous_scen_1", "src": ["../dataset/custom/miscellaneous/images/scen_1"]},
    ...
    {"test_name": "custom_gate_scen_1", "src": ["../dataset/custom/gate/images/scen_1"]},
    ...
    {"test_name": "custom_iron_scen_1", "src": ["../dataset/custom/iron/images/scen_1"]},
    ...
    {"test_name": "custom_bush_2_scen_1", "src": ["../dataset/custom/bush_2/images/scen_1"]},
    ...
    {"test_name": "custom_room_4_scen_1", "src": ["../dataset/custom/room_4/images/scen_1"]},
